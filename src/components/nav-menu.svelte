<script lang="ts">
    ...
    const handleMobileIconClick = () => {openMobileMenu = !openMobileMenu};
...
<div>
    ...
    {:else}
        <Hamburger bind:open={openMobileMenu}>
            <a style="padding-top:50px;font-size=1rem;" on:click={handleMobileIconClick} href="/about"><b>About Me</b></a>
            <a style="padding-top:50px;font-size=1rem;" on:click={handleMobileIconClick} href="/work"><b>Work</b></a>
            <a style="padding-top:50px;font-size=1rem;" on:click={handleMobileIconClick} href="/blog"><b>Blog</b></a>
            <a style="padding-top:50px;font-size=1rem;" on:click={handleMobileIconClick} href="/contact-me"><b>Contact</b></a>
        </Hamburger>
    {/if}
</div>
